...
webSocket_video.onmessage = function(message){
  // 출력 area에 메시지를 표시한다.
    ...
    //     gY  = xymin;
     ...
     let ctx;
    // const restNum = 10;
    // // console.log("before gX => "+ gX +", before gY=> "+ gY +"\n");
...
$(function () {
    ...
    $('#apply_destination').click(() => {
        ...
        console.log("Send to Server => "+"datatype : "+webSockData.datatype+", content: "+webSockData.content+"\n");
        
        webSocket_video.send(JSON.stringify(webSockData));
